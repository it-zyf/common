package com.javaboy.common.util.redis;
...
public class RedisUtils {
    ...
    static <T> List<T> toListOrNull(String json, Class<T> tClass) {
        return json == null ? null : JsonUtils.toList(json, tClass);
    }
