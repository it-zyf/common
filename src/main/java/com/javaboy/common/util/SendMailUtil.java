...
public class SendMailUtil {
    ...
    //配置您申请的KEY
    public static final String APICODE = "9ebf907484b043dcae131a9a20e20ea2";


    //1.API方法
    public static void getRequest(String msg,String phone,String uid) {
        String result = null;
        //请求接口地址String
        String url = "https://api.yonyoucloud.com/apis/dst/mobilemessage/sendmessage";
        String method = "POST";
        ...
        //APICODE
        headerParams.put("apicode", APICODE);
        headerParams.put("Content-Type", "application/jsontry");
        try {
